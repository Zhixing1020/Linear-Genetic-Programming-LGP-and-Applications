...
public enum Objective {
	...
	//=======================2023.4.28, Zhixing dynamic optimization in DJSS =====================
	MEAN_ENERGY_COST("mean-energy-cost"),
	
	MAX_SATISFACTORY("max-satisfactory"),
	MEAN_SATISFACTORY("mean-satisfactory"),
	MEAN_WEIGHTED_SATISFACTORY("mean-weighted-satisfactory")
	//==========================
	;
