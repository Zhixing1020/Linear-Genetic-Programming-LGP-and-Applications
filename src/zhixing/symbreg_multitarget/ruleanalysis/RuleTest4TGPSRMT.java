...
//    protected RuleType ruleType;
    ...
    public RuleTest4TGPSRMT(String trainPath, String dataPath, String dataName, int numRuns, boolean isMO) {
...
//    	state.setup(state, null);
	...
	public void writeToCSV() {
        ...
        for (int i = 0; i < numRuns; i++) {
            ...
            TestResult4CpxGPSRMT result = TestResult4CpxGPSRMT.readFromFile4TGP(sourceFile, isMultiObj);
...
//            result.validate(objectives);
	...
	public static void main(String[] args) {
		...
		RuleTest4TGPSRMT ruleTest = new RuleTest4TGPSRMT(trainPath, dataPath, testSetName, numRuns, numObjectives > 1);
