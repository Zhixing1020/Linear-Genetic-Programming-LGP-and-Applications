...
public class LR_EntityNode extends Extractor_EntityNode{
...
//    }
    ...
    public boolean equals(Object other) {
        if (other instanceof LR_EntityNode) {
        	
        	if(((LR_EntityNode)other).getArguments().equals(arguments)) {
        		return true;
        	}
	...
	public String toString() {
		...
		return "LR_entity" + arguments.toString();
	}

	@Override
	public String toGraphvizString() {
		return "LR[" + String.format("%.2f", arguments.getValue(0)).toString() +","+String.format("%.2f", arguments.getValue(1)).toString()+"]";
	}
