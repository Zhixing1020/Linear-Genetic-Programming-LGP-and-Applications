...
public class TanhRegFunc extends Function_EntityNode{

	public boolean equals(Object other) {
		if(other instanceof TanhRegFunc) {
			
			if(((TanhRegFunc)other).getArguments().equals(arguments) ) {
				return true;
			}
		}
		return false;
    ...
    public void eval(EvolutionState state, int thread, GPData input,
    	...
    	res = a0 + a1 * Math.tanh(a2 * rd.value + a3) + rd.value;
	...
	public String toString() {
		...
		return "TanhRF_entity" + arguments.toString();
	}

	@Override
	public String toGraphvizString() {
		return "TanhRF[" + String.format("%.2f", arguments.getValue(0)).toString() +","
