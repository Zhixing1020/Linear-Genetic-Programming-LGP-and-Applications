...
public interface TGPInterface4SRMT extends CpxGPInterface4SRMT{

	@Override
	default void resetRegisters(final Problem problem, double val, final CpxGPIndividual ind){

		System.err.print("resetRegisters in TGPInterface4SRMT is a null method\n");
	}
...
//		}
//		
//		ind.setInitReg_values(new AttributeGPNode [ind.getNumRegs()]);
		
		System.err.print("prepareExecution in TGPInterface4SRMT is a null method\n");
	}
...
//		return result;
		...
		System.err.print("makeGraphvizRule in TGPInterface4SRMT is a null method\n");
		return null;
	}
}
