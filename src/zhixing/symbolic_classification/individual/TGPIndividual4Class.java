...
import zhixing.symbreg_multitarget.individual.TGPInterface4SRMT;

public class TGPIndividual4Class extends CpxGPIndividual implements TGPInterface4Class, TGPInterface4Problem{
...
//		 if(class_num != t) {
//			 System.err.print("the number of trees in multi-tree GP " + t + " is not equal to the number of classes " + class_num);
//			 System.exit(1);
//		 }
	...
	public void addTrees(GPTree [] sources) {
		trees = sources;
	...
	@Override
	public Double[] execute_outs_wrap(EvolutionState state, int thread, GPData input, ADFStack stack,
