...
public interface LGPInterface4Class extends CpxGPInterface4Class{
...
//	}
	...
	default Double[] execute_outs_wrap(EvolutionState state, int thread, GPData input, ADFStack stack, GPIndividual individual, Problem problem) {
		//returns the predicting label(s) for an instance
