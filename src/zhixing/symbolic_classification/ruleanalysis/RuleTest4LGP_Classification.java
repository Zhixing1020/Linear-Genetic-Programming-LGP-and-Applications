...
public class RuleTest4LGP_Classification {
...
//    protected RuleType ruleType;
	...
	public RuleTest4LGP_Classification(String trainPath, String dataPath, String dataName, int numRuns, int numReg,
...
//        	outputRegs.add(or);
        ...
        for (int i = 0; i < numRuns; i++) {
            ...
            TestResult4CpxGPClass result = TestResult4CpxGPClass.readFromFile4LGP(sourceFile, numRegs, maxIterations, isMultiObj, outputRegs);
...
//                    UniqueTerminalsGatherer gatherer = new UniqueTerminalsGatherer();
	...
	public static void main(String[] args) {
		...
		RuleTest4LGP_Classification ruleTest = new RuleTest4LGP_Classification(trainPath, dataPath, testSetName, numRuns, numRegs, maxIteration, numObjectives > 1);
