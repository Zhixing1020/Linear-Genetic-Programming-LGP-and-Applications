...
//import zhixing.symbreg_multitarget.ruleanalysis.RuleTest4TGPSRMT;
...
public class RuleTest4TGP_Classification {
...
//    protected RuleType ruleType;
    ...
    public RuleTest4TGP_Classification(String trainPath, String dataPath, String dataName, int numRuns, boolean isMO) {
...
//    	state.setup(state, null);
	...
	public void writeToCSV() {
		GPClassification problem = new GPClassification(dataPath, dataName, objectives.get(0), false, parameters);
        ...
        List<TestResult4CpxGPClass> testResults = new ArrayList<>();
        ...
        for (int i = 0; i < numRuns; i++) {
            ...
            TestResult4CpxGPClass result = TestResult4CpxGPClass.readFromFile4TGP(sourceFile, isMultiObj);
...
//            result.validate(objectives);
        ...
        try {
            ...
            writer.newLine();
            for (int i = 0; i < numRuns; i++) {
            	TestResult4CpxGPClass result = testResults.get(i);
	...
	public static void main(String[] args) {
		...
		RuleTest4TGP_Classification ruleTest = new RuleTest4TGP_Classification(trainPath, dataPath, testSetName, numRuns, numObjectives > 1);
