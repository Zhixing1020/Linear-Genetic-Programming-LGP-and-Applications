...
public interface TGPInterface4SR extends CpxGPInterface4SR {

	@Override
	default void resetRegisters(final Problem problem, double val, final CpxGPIndividual ind){

		System.err.print("resetRegisters in TGPInterface4SR is a null method\n");
	}
...
//		ind.setInitReg_values(new AttributeGPNode [ind.getNumRegs()]);
		...
		System.err.print("prepareExecution in TGPInterface4SR is a null method\n");
	}
...
//		return result;
		...
		System.err.print("makeGraphvizRule in TGPInterface4SR is a null method\n");
		return null;
	}
}
