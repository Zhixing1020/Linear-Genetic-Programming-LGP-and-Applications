...
public class SteadystateEvolutionState extends SimpleEvolutionState{
	...
	public void startFresh() 
    {
	    ...
	    //evaluation on initial population
	    // EVALUATION
	...
	public int evolve()
    {
	    ...
	    if(! (breeder instanceof SteadystateBreeder)) {
	    	System.err.print("SteadystateEvolutionState must use SteadystateBreede\n");
	    	System.exit(1);
	    }
	    
	    //steadily bread the population, until popsize individuals are reproduced
//	    population = breeder.breedPopulation(this);
	    for(int s = 0; s<population.subpops.length; s++) {
	    	for(int i = 0; i<population.subpops[s].individuals.length; ) {
	    		i += ((SteadystateBreeder)breeder).SteadybreedPopulation(this, s);
	    		evaluator.evaluatePopulation(this);
	    	}
	    }
