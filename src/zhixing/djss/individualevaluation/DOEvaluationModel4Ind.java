package zhixing.djss.individualevaluation;
...
public class DOEvaluationModel4Ind extends AbstractEvaluationModel {
    ...
    public final static String P_SIM_UPDATE_CYCLE = "update-cycle";
    public final static String P_SIM_DYNAMIC_MODE = "dynamic-mode";
    ...
    public void setup(final EvolutionState state, final Parameter base) {
        ...
        for (int x = 0; x < numSimModels; x++) {
            ...
            p = b.push(P_SIM_UPDATE_CYCLE);
            int cycle = state.parameters.getIntWithDefault(p, null, 10);
            
            p = b.push(P_SIM_DYNAMIC_MODE);
            String mode = state.parameters.getStringWithDefault(p, null, DOSimulation4Ind.ENERGY);

            Simulation4Ind simulation = new DOSimulation4Ind(simSeed,
                    null, numMachines, numJobs, warmupJobs,
                    minNumOps, maxNumOps, utilLevel, dueDateFactor, false, cycle, mode);
