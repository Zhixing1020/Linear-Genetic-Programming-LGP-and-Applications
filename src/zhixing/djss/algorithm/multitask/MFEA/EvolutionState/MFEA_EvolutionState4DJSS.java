...
public class MFEA_EvolutionState4DJSS extends GPRuleEvolutionState {
	@Override
    ...
    evaluator.initializeContacts(this);
	 ...
	 public int evolve() {
		 if (generation > 0)
		    ...
		    Population trial = null;
		    trial = breeder.breedPopulation(this);
		    
		    // EVALUATION
		    ((MFEA_Evaluator)evaluator).evaluatePopulation_MFEA(this, trial);
		    
		    population = ((MFEA_Breeder)breeder).concatenate(this, trial);
