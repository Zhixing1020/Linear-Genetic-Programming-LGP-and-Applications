...
import zhixing.djss.algorithm.multitask.MFEA.ruleanalysis.RuleTest4LGP_MFEA;
...
public class RuleTest4LGP_MPMO extends RuleTest4LGP_M2GP{
	
	protected List<Integer> outputReg4Sim;
	protected List<Integer> outputRegs;
	
	public RuleTest4LGP_MPMO(String trainPath,int numRuns,
	...
	public void writeToCSV(int index, int numtests) {
        ...
        for (int i = 0; i < numRuns; i++) {
            ...
            TestResult4CpxGP result = TestResult4LGP_MPMO.readFromFileMPMO(sourceFile, numRegs, maxIterations, index, numtests, outputRegs);
...
//            		((LGPIndividual_MFEA)result.getGenerationalRule(j)).setOutputRegister(outputReg4Sim);
...
//                            result.getGenerationalTestFitness(j), null, testSet, objective_list, index);
            		LGPIndividual_MPMO4DJSS res_ind = ((LGPIndividual_MPMO4DJSS)result.getGenerationalRule(j));
...
//                    }
	...
	public static void main(String[] args) {
		...
		RuleTest4LGP_MPMO ruleTest = new RuleTest4LGP_MPMO(trainPath, numRuns, testScenario, testSetNames, outputRegs4Sim, new ArrayList<>(), numRegs, maxIteration, outputRegs);
