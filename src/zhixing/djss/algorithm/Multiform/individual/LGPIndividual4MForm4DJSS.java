package zhixing.djss.algorithm.Multiform.individual;
...
public class LGPIndividual4MForm4DJSS extends LGPIndividual4MForm implements LGPInterface4DJSS{
...
//							si = getPrimitives().indexOf(name);
							frequency[si + this.getDimension_fun()] ++;
						}
//						else {
