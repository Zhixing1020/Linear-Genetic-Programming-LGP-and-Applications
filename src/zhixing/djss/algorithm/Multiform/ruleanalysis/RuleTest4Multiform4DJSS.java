...
public class RuleTest4Multiform4DJSS extends RuleTest4LGP{
	
	public RuleTest4Multiform4DJSS(String trainPath,int numRuns,
	...
	public void writeToCSV() {
        ...
        List<TestResult4Multiform4DJSS> testResults = new ArrayList<>();
        ...
        for (int i = 0; i < numRuns; i++) {
            ...
            TestResult4Multiform4DJSS result = TestResult4Multiform4DJSS.readFromFileMultiForm(sourceFile, numRegs, maxIterations, isMultiObj);
...
//            result.validate(objectives);
	...
	public static void main(String[] args) {
		...
		RuleTest4Multiform4DJSS ruleTest = new RuleTest4Multiform4DJSS(trainPath, numRuns, testScenario, testSetName, numRegs, maxIteration, numObjectives > 1);
