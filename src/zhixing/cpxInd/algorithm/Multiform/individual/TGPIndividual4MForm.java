...
public abstract class TGPIndividual4MForm extends CpxGPIndividual implements TGPInterface4Problem{
...
//	public ArrayList<Pair<String, ArrayList<String>>> getAdjacencyTable(GPNode start_node){
//		
//		if(start_node == null){
...
//	}
	...
	public boolean issameRepresentation(Object ind) {
		...
		if( ind instanceof TGPIndividual4MForm ) {
				return true;
		}
...
//	@Override
//	public double evaluate(EvolutionState state, int thread, GPData input, ADFStack stack, GPIndividual individual,
//			Problem problem) {
//		if(input == null) {
...
//        trees[0].child.eval(state, thread, input, stack, this, problem);
//
//        return tmp.value;
//	}
