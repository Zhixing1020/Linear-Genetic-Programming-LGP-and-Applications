...
public class BetterParentRes_LGP_2PXover extends LGP2PointCrossoverPipeline{
	...
	public int produce(final int min, 
	        ...
	        for(int q=start, parnt = 0;q<n+start; /* no increment */)  // keep on going until we're filled up
	            ...
	            int retain_par = t1;
	            if (((LGPIndividual)parents[t2]).fitness.betterThan(((LGPIndividual)parents[retain_par]).fitness)){
	            	retain_par = t2;
	            }
