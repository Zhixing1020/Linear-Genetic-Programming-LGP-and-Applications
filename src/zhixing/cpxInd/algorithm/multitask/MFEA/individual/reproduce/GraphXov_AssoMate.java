...
public class GraphXov_AssoMate extends zhixing.cpxInd.individual.reproduce.GraphCrossover {
	public static final String P_TRANSFER_RATE = "trans_rate";
	
	public static final String GRAPH_CROSSOVER_AS = "graphcross_AS";
	...
	public void setup(final EvolutionState state, final Parameter base){
		...
		Parameter def = LGPDefaults.base().push(GRAPH_CROSSOVER_AS);
