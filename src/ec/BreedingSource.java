...
public abstract class BreedingSource implements Prototype, RandomChoiceChooserD
    ...
    */
	...
	public int produce(int min, int max, int start, int subpopulation, Individual[] sink, EvolutionState state,
			int thread, Individual[] parnts)
	{
		System.err.print("This is an empty method, please override it\n");
		System.exit(1);
		return 0;
	}
	public Individual produce(int subpopulation, Individual i, EvolutionState state, int thread)
	{
